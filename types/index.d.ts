...
declare module 'uranio-schema/typ/atom' {
  ...
  /** --uranio-generate-start */
	...
	export type AtomName = 'superuser' | 'user' | 'group' | 'media' | 'error' | 'request'
	...
	type CustomResponse<A extends schema.AtomName, R extends schema.RouteName<A>, D extends schema.Depth = 0> =
		A extends 'superuser' ?
			never :
		A extends 'user' ?
			never :
