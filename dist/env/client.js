...
const urn_ctx = uranio_utils_1.urn_context.create(default_env_1.trx_client_env, is_production(), 'TRX:ENV:CLIENT');
...
function set_client_env() {
    ...
    // urn_ctx.set_env();
    const api_env = client_1.default.env.set_client_env();
    set(api_env);
    return api_env;
}
