...
exports.has_property = exports.get_full_properties_definition = exports.get_custom_property_definitions = exports.get_property_definition = exports.get_definition = exports.get_all_definitions = exports.get_plural = exports.validate_name = exports.get_names = exports.add_definition = exports.add_route_definition = exports.get_dock_definition = exports.get_routes_definition_with_defaults = exports.get_routes_definition = exports.get_route_def = void 0;
...
function add_route_definition(atom_name, route_name, route_definition) {
    return uranio_api_1.default.book.add_route_definition(atom_name, route_name, route_definition);
}
exports.add_route_definition = add_route_definition;
function add_definition(atom_name, atom_definition) {
    return uranio_api_1.default.book.add_definition(atom_name, atom_definition);
}
exports.add_definition = add_definition;
function get_names() {
    return uranio_api_1.default.book.get_names();
}
exports.get_names = get_names;
function validate_name(atom_name) {
    return uranio_api_1.default.book.validate_name(atom_name);
}
exports.validate_name = validate_name;
function get_plural(atom_name) {
    return uranio_api_1.default.book.get_plural(atom_name);
}
exports.get_plural = get_plural;
function get_all_definitions() {
    return uranio_api_1.default.book.get_all_definitions();
}
exports.get_all_definitions = get_all_definitions;
function get_definition(atom_name) {
    return uranio_api_1.default.book.get_definition(atom_name);
}
